...
class YmereChecker(WebsiteChecker):
    ...
    def set_parameters(self):
        ...
        self.previous_listings_file_name = "C:\\Users\\maxgu\\projects\\ymere_checker\\listings\\ymere_listings.txt"


    def get_listing_link(self, listing):
        relative_url = listing.parent.parent.parent.attrs['href']
        return "https://aanbod.ymere.nl" + relative_url